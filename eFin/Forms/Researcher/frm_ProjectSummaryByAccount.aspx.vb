...
Partial Class Forms_Researcher_frm_ProjectSummaryByAccount
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load, HeaderControl.UpdateEmployeeDetail
        ...
        If Not Me.IsPostBack Then
            CType(Page.Master, MasterPage).PageIdentity = "Enterprise Reporting<br/>eFIN - 05"
        End If
        ...
        'Session("RandomKey") = Nothing ' for testing
        ...
        If Not Me.IsPostBack Then
            ...
            EnableStartAtAccount()  ' Enable the start at account feature
        ...
        Else
            ' Subsequent load, get start and end date from header control
        ...
        Try
            LoadProjectSummaryByAccount(startDate, endDate) ' Load project summary by accounts

            ' Store new start and end date into viewstate
    ...
    ' Retrieve Project Summary by account and bind it to datagrid
    Private Sub LoadProjectSummaryByAccount(ByRef startDate As String, ByRef endDate As String)
    ...
    Private Sub dgProjects_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgProjects.ItemDataBound
        ...
        If e.Item.ItemType = ListItemType.Item OrElse e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If IsNumeric(strAccount) = True Or strAccount = "RT425" Then
                ...
                hyplnk.NavigateUrl = Utils.ApplicationPath + "/frm_ProgressPage.aspx?destPage=" + Utils.ApplicationPath + "/Forms/Researcher/frm_AccountDetails.aspx?value=" + strEncryptedResult + "%26category=PROJECTSINGLEACCOUNT"
            End If
    ...
    Protected Sub btnExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExcel.Click
        ...
        If Not strCPID Is Nothing Then
            HttpContext.Current.Response.AddHeader("Content-Disposition", "attachment; filename=" + strCPID + " - ProjectSummaryByAccount.xls")
        Else
            HttpContext.Current.Response.AddHeader("Content-Disposition", "attachment; filename=ProjectSummaryByAccount.xls")
        End If
        ...
        Utils.ClearControls(Me.dgProjects)
